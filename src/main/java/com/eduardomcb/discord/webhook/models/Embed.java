...
public class Embed implements JSONType.Object {
	...
	public JSONObject toJson() {
		...
		try {
			...
			if (this.author != null)
				obj.put("author", this.author.toJson());
			if (this.image != null)
				obj.put("image", this.image.toJson());
			if (this.thumbnail != null)
				obj.put("thumbnail", this.thumbnail.toJson());
			if (this.footer != null)
				obj.put("footer", this.footer.toJson());

			if (fields != null) {
				for (Field item : this.fields) {
					fieldsArr.put(item.toJson());
				}
